...
os.environ['HF_ENDPOINT'] = 'https://hf-mirror.com'
model_name = 'D:\\AIClass_demo\\AIClass_demo0\\single_work\\xlm-roberta-large-nli'
...
# 加载原始训练集和测试集
train_path = "D:\\AIClass_demo\\AIClass_demo0\\single_work\\dataSet\\train.csv"
...
#     if "layer.20" in name or "layer.21" in name or "layer.22" in name or "layer.23" in name:
...
#     {
#         'params': [p for n, p in model.named_parameters() if 'roberta.encoder.layer.20' in n or
#                    'roberta.encoder.layer.21' in n or
#                    'roberta.encoder.layer.22' in n or
#                    'roberta.encoder.layer.23' in n],
#         'lr': 1e-5
#     },
#     {
...
test_data = pd.read_csv('D:\\AIClass_demo\\AIClass_demo0\\single_work\\dataSet\\test.csv')
